          ...
          <Col>
            ...
            <Navbar.Collapse>
                ...
                {clienteLogueado.email ? (
                  <>
                    <div className="text-light text-center pb-2 pt-1 mx-4 fuente fs-6 fw-bold"> {saludoNavbarCliente}           </div>
                    <NavLink end className="nav-item nav-link" to="/carta"> Nuestra Carta</NavLink>
                    <Button variant="danger" className="fuente fs-5 mx-2" onClick={logoutCliente}> Logout</Button>
                  </>
                ) : (
                  <>
                    <NavLink end className="nav-item nav-link" to="/loginCliente"> Login</NavLink>
                    <NavLink end className="nav-item nav-link" to="/registro"> Registrarse </NavLink>
                    <NavLink end className="nav-item nav-link" to="/loginUsuario"> Administrador </NavLink>
                  </>
                )}
              </Nav>
            </Navbar.Collapse>
              ...
              <Nav className="me-auto text-center">
                {usuarioLogueado.email ? (
                  ...
                  <div className="text-light px-3 pb-2 fw-bold">{saludoNavbar}</div>
                    <NavLink end className="nav-item nav-link" to="/administrador"> Productos </NavLink>
                    <NavLink end className="nav-item nav-link" to="/adminUsuarios"> Usuarios </NavLink>
                    <NavLink end className="nav-item nav-link" to="/administrador/pedidosAdmin">Pedidos</NavLink>
                    <Button variant="danger" className="fuente fs-6 mx-2" onClick={logout}> Logout </Button>
                  </>
                ) : (
                  <>
