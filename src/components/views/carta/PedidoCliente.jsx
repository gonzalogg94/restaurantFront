 ...
 const [pedidos, setPedidos] = useState([]);
  ...
  useEffect(() => {
    consultarPedidosApi().then((respuesta) => {
      ...
      setPedidos(respuesta.filter((pedido) => pedido.nombreClientePedido ===  clienteCarro))
    });
  }, []);
      ...
      <Container>
        ...
        <div className="table-responsive">
          <Table striped bordered hover variant="dark">
            ...
            <tbody>
              {pedidos.map((pedido) =><TablaPedido key={pedido._id}  pedido={pedido} setPedidos={setPedidos} />
              )}
            </tbody>
          </Table>
        </div>
